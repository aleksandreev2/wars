 ...
 * The NPC is deliberately a vanilla combat mob so path-finding and melee combat are server-side and deterministic.
 */
public final class TestNpcService {
    ...
    public static void reset(ServerWorld world, BlockPos center, MatchState match) {
        if (npc == null || npcSide == null || match == null || match.isFinished()) {
            return;
        }
    ...
    public static void tick(ServerWorld world, BlockPos center, MatchState match) {
        if (npc == null || npcSide == null || world == null || center == null || match == null || match.isFinished()) {
            return;
        }
        if (!npc.isAlive()) {
            return;
    ...
    public static Side sideOf(Entity entity) {
        if (entity == null || npc == null || npcSide == null) {
            return null;
        }
